...
<main>
   ...
   <section class="flex-container-formsection">
      ...
      <form id="newcustomerreg" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
         ...
         <label for="gender">Gender</label><br><span class="error">* <?php echo $genderErr;?></span>
         Male:
         <input type="radio" id="male" name="gender" <?php if (isset($gender) && $gender=="male") echo "checked";?> value="male" required><br>
         Female:
         <input type="radio" id="female" name="gender" <?php if (isset($gender) && $gender=="female") echo "checked";?> value="female" required><br>
